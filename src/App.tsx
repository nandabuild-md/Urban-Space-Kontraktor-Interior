    ...
    <div className="min-h-screen bg-surface text-on-surface selection:bg-primary selection:text-on-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#131313]/80 backdrop-blur-md flex justify-between items-center px-8 py-6 max-w-full">
        ...
        <div className="hidden md:flex gap-12 items-center">
          ...
          <button className="bg-primary text-on-primary px-6 py-2 text-sm font-semibold rounded-sm hover:bg-primary-container transition-all active:scale-95 duration-200">
            Konsultasi Gratis
          </button>
        </div>
      </nav>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl space-y-8">
            ...
            <div className="flex flex-wrap gap-6 pt-4">
              ...
              <button className="border border-outline-variant/15 text-primary px-8 py-4 text-sm font-bold rounded-sm hover:bg-surface-container-highest transition-all">
                Konsultasi Gratis
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            <div className="sticky top-32 space-y-8">
              ...
              <button className="bg-primary text-on-primary px-8 py-4 text-sm font-bold rounded-sm inline-flex items-center gap-3">
      ...
      <section className="py-40 bg-surface relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-8 text-center relative z-10">
          ...
          <button className="bg-primary text-on-primary px-12 py-6 text-lg font-bold rounded-sm hover:scale-105 transition-all shadow-[0_0_40px_rgba(230,195,100,0.3)] inline-flex items-center gap-4">
      ...
      <footer className="bg-[#0e0e0e] pt-20 pb-10">
        ...
        <div className="max-w-7xl mx-auto px-12 mt-20 pt-8 border-t border-outline-variant/5 text-center">
